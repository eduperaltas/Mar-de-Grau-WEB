...
Future<User> signInWithGoogle() async {
  ...
  if (user != null) {
    ...
    iUser usuario = iUser(uid: user.uid, name: user.displayName.toString(), email:user.email.toString(), photoURL: user.photoURL.toString());
    CloudFirestoreAPI(uid: usuario.uid).createUserData(usuario);
  }
...
Future<User> registerWithEmailPassword(String email, String password) async {
  ...
  try {
    ...
    if (user != null) {
      uid = user.uid;
      userEmail = user.email;
      iUser usuario = iUser(uid: user.uid, name: '', email:user.email.toString(), photoURL: '');
      CloudFirestoreAPI(uid: usuario.uid).createUserData(usuario);
